...
public:
   ...
   */
  template <typename T> ParameterLogger &operator<<(T param);
   ...
   * \return This ParameterLogger, so it's chainable.
   */
  template <typename T> ParameterLogger &operator<<(std::vector<T> vector);
};
...
// define log level with default value or use defined preprocessor symbol
// LOG_LEVEL
#ifdef LOG_LEVEL
...
// simplified prefix
#define LOG_APPEND_PREFIX LOG_OUT << g_LOG_component_name << ": ";

// copied from ns-3.34, file: core/log.h
#define LOG_ERROR(msg) NS_LOG(LOG_ERROR, msg)

// copied from ns-3.34, file: core/log.h
#define LOG_WARN(msg) NS_LOG(LOG_WARN, msg)

// copied from ns-3.34, file: core/log.h
#define LOG_DEBUG(msg) NS_LOG(LOG_DEBUG, msg)

// copied from ns-3.34, file: core/log.h
#define LOG_INFO(msg) NS_LOG(LOG_INFO, msg)

// copied from ns-3.34, file: core/log.h
#define LOG_LOGIC(msg) NS_LOG(LOG_LOGIC, msg)
